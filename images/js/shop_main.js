	...
	if (!!document.querySelector('#product-tabs')) {
		...
		if (gr_active_tab!=null && $(gr_active_tab).length) {
			...
			if (!!desktopFirst && !!mobileFirst) {
				...
				desktopFirst.children[0].classList.remove('active');
				mobileFirst.children[0].classList.remove('active');
			};
			if (!!firstTab) {
			...
			for (i = 0; i < gr_active_tabs.length; i++) {
				gr_active_tabs[i].classList.add('active');
        ...
        queue: {
                ...
                $(document).on('click', '.get-promo-link', function (e) {
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            let promoClose = '<div class="promo-close-btn"><span><svg class="gr-svg-icon gr_big_icon"><use xlink:href="#icon_shop_close"></use></svg><svg class="gr-svg-icon"><use xlink:href="#icon_shop_close_small"></use></svg><svg class="gr-svg-icon gr_small_icon"><use xlink:href="#icon_shop_close_mini"></use></svg></span></div>';
                            ...
                            setTimeout(function () {
                                ...
                                $('.promo-products-list #shop2-alert-body').append(promoClose);
            ...
            cartPage: function() {
                ...
                if (shop2.mode=='cart') {
                    ...
                    function initCart($div) {
                        ...
                        $('#shop2-cart .cart-delete a').unbind('click');
            ...
            init: function() {
                ...
                $(document).on('click', function(e){
                    ...
                    setTimeout(function(){
                        $('#shop2-alert-ok').html('<span><svg class="gr-svg-icon gr_big_icon"><use xlink:href="#icon_shop_close"></use></svg><svg class="gr-svg-icon"><use xlink:href="#icon_shop_close_small"></use></svg><svg class="gr-svg-icon gr_small_icon"><use xlink:href="#icon_shop_close_mini"></use></svg></span>');
                    }, 250)
                }); // Клик по документу
